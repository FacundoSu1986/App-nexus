...
class NexusAPI:
    ...
    def __init__(self, api_key: str, game_domain: str = SKYRIM_SE_DOMAIN) -> None:
        ...
        self.hourly_quota_remaining: str = "Unknown"
    ...
    def _request(
        ...
        *,
        ...
        self.daily_quota_remaining = str(response.headers.get("x-rl-daily-remaining", "Unknown"))
        self.hourly_quota_remaining = str(response.headers.get("x-rl-hourly-remaining", "Unknown"))
